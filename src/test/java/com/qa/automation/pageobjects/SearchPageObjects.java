...
public class SearchPageObjects {
	...
	private By ListOfProductElement = By.xpath("//div[@class='a-section a-spacing-small a-spacing-top-small']//h2");
	
	// Search page methods
	public void validateSearchPageTitle()
	{
		 WebDriverWait webDriverWait1 = new WebDriverWait(driver,20);
	     //logger.info("Waiting for product title : \"Amazon.in : Laptop", driver.getTitle());
	     webDriverWait1.until(ExpectedConditions.titleContains("Amazon.in"));
	     //logger.info("Waiting for product title : \"Amazon.in\"");
